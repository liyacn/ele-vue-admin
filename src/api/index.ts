...
export default {
  ...
  changePwd: api<M.PasswordArgs, unknown>('/user/password', true), //修改密码
  ...
  roleCreate: api<M.RoleCreateArgs, unknown>('/system/role/create'), //创建角色
  roleUpdate: api<M.RoleUpdateArgs, unknown>('/system/role/update'), //更新角色
